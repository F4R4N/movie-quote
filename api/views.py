...
class AdminEditAndDeleteQuoteView(APIView):
    ...
    def put(self, request, key, format=None):
        if (
            "quote" not in request.data
            and "show" not in request.data
            and "role" not in request.data
            and "contain_adult_lang" not in request.data
        ):
            return Response(
...
class AdminEditShowView(APIView):
    ...
    def put(self, request, slug, format=None):
        ...
        show.save()
        return Response(
            status=status.HTTP_200_OK, data={"detail": "show updated"}
        )
...
class AdminEditRoleView(APIView):
    ...
    def put(self, request, slug, format=None):
        ...
        role.save()
        return Response(
            status=status.HTTP_200_OK, data={"detail": "role updated."}
        )
...
class AdminEditUserView(APIView):
    ...
    it should include at least one of : [first_name, last_name, username,
    email, (together [password1,password2]), (only main superuser can modify
    this [is_superuser, is_active, is_staff]) ].
    """
    ...
    def put(self, request, pk, format=None):
        ...
        instance.save()
        return Response(
            status=status.HTTP_200_OK, data={"detail": "user updated"}
        )
...
class AdminDeleteUserView(APIView):
    ...
    def delete(self, request, pk, format=None):
        ...
        return Response(
            status=status.HTTP_200_OK,
            data={
                "detail": "user '{0}' deleted".format(deletable_user.username)
            },
        )
